...
from page.baidu_homepage import HomePage
from public import base
from public.log import Log

testdata = base.get_excel_data('../dataconfig/test.xlsx', 'test2')
...
class BaiduSearch(unittest.TestCase):
    ...
    def test_1baidu_search(self, data):
        ...
        # self.home_page.back()
        # print(self.home_page.get_title())
        self.assertIn(data.get("checkpoint"), self.home_page.get_title(), msg='和预期不一样')
    #
    ...
    # def test_3baidu_search(self, data):
    #     self.home_page.sleep(1)
    #     self.home_page.search_input(data.get("name"))  # 调用页面对象中的方法
    #     self.home_page.send_submit_btn()  # 调用页面对象类中的点击搜索按钮方法
    #     self.home_page.sleep(1)
    #     self.home_page.take_screenshot(data.get("name"))  # 调用基类截图方法
    #     self.home_page.back()
    #     print(self.home_page.get_element("xpath=>//*[@id='2']","pan"))
    #     # self.assertIn(data.get("name"), self.home_page.get_element(xpath='pan'), msg='和预期不一样')
